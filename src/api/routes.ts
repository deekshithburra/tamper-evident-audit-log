...
export function buildRoutes(deps: {
  ...
  router.use(authenticate(deps.config));

  // ------------------------------------------------------------------ Scenario A: write

  router.post('/audit/events', requireCapability('events:write'), (req: Request, res: Response) => {
  ...
  router.get('/audit/events', requireCapability('events:read'), (req: Request, res: Response) => {
  ...
  router.get(
    ...
    (req: Request, res: Response) => {
      res.json(present(audit.getByEventId(req.params.eventId as string)));
    },
  );

  // ------------------------------------------------------------------ Scenario A: verification

  router.get('/audit/verify', requireCapability('chain:verify'), (req: Request, res: Response) => {
  ...
  router.get('/audit/export', requireCapability('records:export'), (req: Request, res: Response) => {
  ...
  router.get(
    ...
    (req: Request, res: Response) => {
      ...
      const report = compliance.generateAccessReport(params, req.principal?.id ?? 'unknown');
      res.json(report);
    },
  );
